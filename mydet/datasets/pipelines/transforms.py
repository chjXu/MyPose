...
from mydet.core import PolygonMasks, find_inside_bboxes
from mydet.core.evaluation.bbox_overlaps import bbox_overlaps
from mydet.utils import log_img_scale
