...
from mypose.core import DistEvalHook, EvalHook, build_optimizers
from mypose.core.distributed_wrapper import DistributedDataParallelWrapper
from mypose.datasets import build_dataloader, build_dataset
from mypose.utils import get_root_logger
...
try:
    ...
    from mypose.core import Fp16OptimizerHook
...
def train_model(model,
    ...
    # data_loaders = tqdm(data_loaders, file=sys.stdout)
